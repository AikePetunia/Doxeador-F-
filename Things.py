...
nameOnInternet = input(
    "Escribe el nick de la persona que doxees ").strip().lower()

whatDoYouWannaKnow = input(
    "Que necesitas de la persona? 1) Dirección 2) Correo 3) Número de teléfono 4) Dirección IP 5) DOXEO COMPLETO "
).strip().lower()
...
if nameOnInternet in whitelist:
    print(f"Persona no posible de vulnerable por protección")
else:
